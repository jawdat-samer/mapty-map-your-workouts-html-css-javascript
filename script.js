...
class Cycling extends Workout {
    ...
    calcSpeed() {
        // km/h
        this.speed = parseInt(this.distance / (this.duration / 60));
...
class App {
    ...
    constructor() {
        ...
        inputType.addEventListener('change', this._toggleElvationField.bind(this));
    ...
    _moveToPopup(e) {
        ...
        //             this._map.flyTo(workout.coords, 13);
        //         }
        //     });
        // }
